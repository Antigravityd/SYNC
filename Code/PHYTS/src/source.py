...
class Cylindrical(Source):
    def __init__(self, projectile, energy, *, center=(0.0, 0.0), bounds=(0.0, 0.0), r_out=0.0, r_in=0.0,
        ...
        super().__init__(1, projectile, **kwargs)
        self.x0 = center[0]
        self.y0 = center[1]
        self.z0 = bounds[0]
        self.z1 = bounds[1]
...
class Rectangular(Source):
    def __init__(self, projectile, energy, *,
                 xbound=(0.0, 0.0), ybound=(0.0, 0.0), zbound=(0.0, 0.0),
                 elevation=0.0, azimuth=None, dispersion=0.0, **kwargs):
        super().__init__(2, projectile, **kwargs)
        self.x0 = xbound[0]
        self.x1 = xbound[1]
        self.y0 = ybound[0]
        self.y1 = ybound[1]
...
class Gaussian(Source):
    def __init__(self, projectile, energy, *,
                 center=(0.0, 0.0, 0.0), fwhms=(0.0, 0.0, 0.0), zbound=None, elevation=0.0,
                 azimuth=None, dispersion=0.0, **kwargs):
        if len(center) == 3 and len(fwhms) == 3:
            super().__init__(3, projectile, **kwargs)
            self.x0 = center[0]
            self.y0 = center[1]
            self.z0 = center[2]
            self.x1 = fwhms[0]
            ...
            self.dom = dispersion
            self.e0 = projectile_energy
        elif len(center) == 2 and zbound is not None:
            self.x0 = center[0]
            self.y0 = center[1]
            self.r1 = fwhms
            self.z0 = zbound[0]
...
class Parabolic(Source):
    ...
    def __init__(self, projectile, energy, *,
        ...
        if len(width) == 2:
            super().__init__(7, projectile, **kwargs)
            self.x0 = center[0]
            self.y0 = center[1]
            self.x1 = width[0]
            self.y1 = width[1]
            ...
            super().__init__(15, projectile, **kwargs)
            self.x0 = center[0]
            self.y0 = center[1]
            self.r1 = width
            self.z0 = zbound[0]
...
class Spherical(Source):
    def __init__(self, projectile, energy, *,
        ...
        super().__init__(9, projectile, **kwargs)
        self.x0 = center[0]
        self.y0 = center[1]
        self.z0 = center[2]
        self.r1 = r_in
...
class Conical(Source):
    def __init__(self, projectile, energy, *,
        ...
        super().__init__(18, projectile, **kwargs)
        self.x0 = top[0]
        self.y0 = top[1]
        self.z0 = top[2]
        self.x1 = altitude[0]
...
class Prism(Source):
    def __init__(self, projectile, energy, *, origin=(0.0, 0.0, 0.0), side1=(0.0, 0.0, 0.0),
                 side2=(0.0, 0.0, 0.0), extrusion=(0.0, 0.0, 0.0), attenuation=0.0,
                 elevation=1.0, azimuth=None, dispersion=0.0, **kwargs):
        super().__init__(20, projectile, **kwargs)
        self.x0 = origin[0]
        self.y0 = origin[1]
        self.z0 = origin[2]
        self.x1 = side1[0]
