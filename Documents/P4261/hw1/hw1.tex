...
\section*{3a}
The Debye model presumes that oscillations within a solid are quantized sound waves, polarized in three directions, with a maximum possible frequency due to a limited number of degrees of freedom in the solid.
