...
\begin{proof}
  In each case, energy will be conserved, as will the momentum in the original rest frame; the latter necessarily means
  both decay products will have the same momentum magnitude $p = m\gamma v$:
  \[
    m_{0}c^{2} = m_{a}\gamma_{b} c^{2} + m_{b}\gamma_{b} c^{2}
    = \frac{pc^{2}}{v_{a}} + \frac{pc^{2}}{v_{b}}
  \]
  \[
    \Leftrightarrow K =
  \]
